...
import cv2
import copy
from dataloaders._base import PlantsBase
...
class Plants(PlantsBase):
    def __init__(self, datapath, overfit=False, area_threshold=50):
        super().__init__(datapath, overfit)
    ...
    def __getitem__(self, index):
        ...
        # apply reduction for null boxes also on other data
        masks = masks[[~(area == 0)]]
